          ...
          <TabsContent value="strategies" className="mt-0">
            <div className="bg-white rounded-b-lg overflow-hidden border border-gray-200 p-8">
              <div className="max-w-4xl mx-auto">
                <h3 className="text-2xl font-semibold text-gray-900 mb-6">Active Trading Strategies</h3>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <h4 className="text-lg font-semibold text-gray-900">Momentum Trading Strategy</h4>
                            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">Active</span>
                          </div>
                          <p className="text-sm text-gray-600 mb-4">
                            Identifies strong trending stocks and executes trades based on momentum indicators including RSI, MACD, and volume analysis.
                          </p>
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div>
                              <p className="text-gray-500">Win Rate</p>
                              <p className="text-lg font-semibold text-gray-900">67.3%</p>
                            </div>
                            <div>
                  ...
                  <Card className="border border-gray-200 hover:border-blue-300 transition-colors">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <h4 className="text-lg font-semibold text-gray-900">Value Investing Strategy</h4>
                            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">Active</span>
                          </div>
                          <p className="text-sm text-gray-600 mb-4">
                            Long-term value strategy focusing on undervalued stocks with strong fundamentals and dividend yields.
                          </p>
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div>
                              <p className="text-gray-500">Win Rate</p>
                              <p className="text-lg font-semibold text-gray-900">71.8%</p>
                            </div>
                            <div>
                              <p className="text-gray-500">Total Trades</p>
                  ...
                  <Card className="border border-gray-200 hover:border-blue-300 transition-colors">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <h4 className="text-lg font-semibold text-gray-900">AI-Powered Adaptive Strategy</h4>
                            <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-semibold">Beta</span>
                          </div>
                          <p className="text-sm text-gray-600 mb-4">
                            Machine learning model that adapts to market conditions using Gemini AI for real-time analysis and decision making.
                          </p>
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div>
                              <p className="text-gray-500">Win Rate</p>
                              <p className="text-lg font-semibold text-gray-900">73.5%</p>
                            </div>
                            <div>
                              <p className="text-gray-500">Total Trades</p>
                            ...
                            <div>
                              <p className="text-gray-500">Avg Return</p>
                              <p className="text-lg font-semibold text-green-600">+4.7%</p>
                            </div>
                          </div>
                        </div>
                        <Button variant="outline" className="ml-4">
